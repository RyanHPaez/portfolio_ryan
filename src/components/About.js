    ...
    <div className="about">
      <div class="container">
        <div class="row align-items-center my-5">
          <div class="col-lg-5">
            <img
              class="img-fluid rounded mb-4 mb-lg-1"
          ...
          <div class="col-lg-5-6">
            ...
            <p>
              ...
              Western Jet Aviation in Van Nuys, CA. I love staying busy and
              focused. I have amazing drive and am persistent. When I found
